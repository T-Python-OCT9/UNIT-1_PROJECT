...
class PersonalWallet():
    ...
    def main():
        ...
        name_list, acc_num_list, acc_balance_list = PersonalWallet.read_file()
        option = 0
        while option != 6:
    ...
    # if statement for all of the options
            if option == 1:
                name_list, acc_num_list, acc_balance_list = PersonalWallet.open_acc(name_list, acc_num_list, acc_balance_list)

            elif option == 2:
                name_list, acc_num_list, acc_balance_list = PersonalWallet.close_account(name_list, acc_num_list, acc_balance_list)

            elif option == 3:
                name_list, acc_num_list, acc_balance_list = PersonalWallet.withdraw(name_list, acc_num_list, acc_balance_list)

            elif option == 4:
                name_list, acc_num_list, acc_balance_list = PersonalWallet.add_money(name_list, acc_num_list, acc_balance_list)

            elif option == 5:
                PersonalWallet.summary(name_list, acc_num_list, acc_balance_list)

            elif option == 6:
                PersonalWallet.exit(name_list, acc_num_list, acc_balance_list)
    ...
    # reading the text file
        ...
        for line in lines:
            ...
            acc_balance_list.append(float(information[1]))
            name_list.append(information[2])
        return name_list, acc_num_list, acc_balance_list


    # Function for opening an account
    def open_acc(name_list, acc_num_list, acc_balance_list):
        ...
        acc_balance_list.append(initial_balance)
    ...
    def close_account(name_list, acc_num_list, acc_balance_list):
    ...
    def withdraw(name_list, acc_num_list, acc_balance_list):
        account_number = input("\nEnter your account number:\n")
        index = 0
        found = False
        for i in acc_num_list:
            ...
            while problem:
                try:
                    ...
                    if withdraw_amount < 0:  # if not a positive int print message and ask for input again
                        ...
                        break
                    amount = acc_balance_list[index] - withdraw_amount
                    # if the amount is greater than or = 0 it will take the amount away from the balance list.
                    if amount > 0:
                        acc_balance_list[index] = acc_balance_list[index] - withdraw_amount
                        print(f"An amount of ${(withdraw_amount)} is removed from your account {account_number}")
                        print(f"Your current balance is $ {acc_balance_list[index]:,} ")
                        print("")
                        problem = False
                    else:
                        print(f"Unfortunately you don't have a sufficient funds{name_list[index]:,}")
                        print(f"Your balance after your current transaction is $ {acc_balance_list[index]}:,")
                        print("")
                        print("*"*55)
                        break
                finally:
    ...
    def add_money(name_list, acc_num_list, acc_balance_list):
        account_number = input("\nEnter your account number:\n")
        index = 0
        found = False
        for i in acc_num_list:
            ...
            while problem:
                try:
                    ...
                    if deposit_amount < 0:  # if not a positive int print message and ask for input again
                        print("ERROR -- input must be a positive integer, try again")
                        break
                    amount = acc_balance_list[index] + deposit_amount
                    # if the amount is greater than or = 0 it will added to the balance list.
                    if amount > 0:
                        acc_balance_list[index] = acc_balance_list[index] + deposit_amount
    ...
    def summary(name_list, acc_num_list, acc_balance_list):
        if len(name_list) > 0:
            for i in range(len(acc_num_list)):
                print(f"\nClient {name_list[i]} who's account number is {acc_num_list[i]} has $ {acc_balance_list[i]: ,} \n")
                #using lambda to get the total deposited 
                total = reduce(lambda total_depo, current: total_depo+current, acc_balance_list)
            print(f"\nTotal amount of deposit in the system is: ${total: ,}")
            largest_deposit = max(acc_balance_list)
            print(f"\nThe largest amount of deposit in the system is:  ${largest_deposit: ,}\n ")
            print("*"*55)
        else:
            print("There is no account data !")   

    def exit(name_list, acc_num_list, acc_balance_list):
        print("Thank You For Using The Personal Wallet program !")
        quit_file = open("wallets_data.txt", "w", encoding="utf-8")
        for i in range(len(acc_num_list)):
            save = acc_num_list[i] + " " + str(acc_balance_list[i]) + " " + name_list[i] + "\n"
